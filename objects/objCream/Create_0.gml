...
player_animate = function()
{
    switch (animation_data.index)
    {
        ...
        {
            var variants = [global.ani_cream_teeter_front_v0, global.ani_cream_teeter_back_v0];
        ...
        {
            var variants = [global.ani_cream_turn_v0, global.ani_cream_turn_brake_v0];
            animation_set(variants);
            player_set_radii(6, 14);
            image_angle = gravity_direction;
            break;
        ...
        {
            var variants = [global.ani_cream_run_v0, global.ani_cream_run_v1, global.ani_cream_run_v2, global.ani_cream_run_v3, global.ani_cream_run_v4];
        ...
        {
            var variants = [global.ani_cream_brake_v0, global.ani_cream_brake_fast_v0];
            animation_set(variants);
            player_set_radii(6, 14);
            image_angle = gravity_direction;
            break;
        ...
        {
            var variants = [global.ani_cream_look_v0, global.ani_cream_look_v1];
            animation_set(variants);
            player_set_radii(6, 14);
            image_angle = gravity_direction;
            break;
        ...
        {
            var variants = [global.ani_cream_crouch_v0, global.ani_cream_crouch_v1];
            animation_set(variants);
            player_set_radii(6, 14);
            image_angle = gravity_direction;
            break;
        ...
        {
            var variants = [global.ani_cream_fall_v0, global.ani_cream_fall_v1];
        ...
        {
            var variants = [global.ani_cream_jump_v0, global.ani_cream_jump_v1, global.ani_cream_jump_v2];
        ...
        {
            var variants = [global.ani_cream_spring_v0, global.ani_cream_spring_v1, global.ani_cream_spring_v2];
            if (animation_data.variant == 0)
            {
                if (y_speed > 0)
                {
        ...
        {
            animation_set(global.ani_cream_spring_twirl);
            player_set_radii(6, 14);
            image_angle = gravity_direction;
            break;
        }
